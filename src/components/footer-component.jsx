      ...
      <div className="w-full  px-8 pb-4 lg:max-w-full mt-24" style={{ backgroundColor: bgColor }}>
        <div className="grid grid-cols-1 justify-between gap-4 md:grid-cols-3">
          ...
          <div className="my-6  md:w-full ">
                <p className="text-small font-serif font-thin">
                    {text.footerText}
                </p>
          </div>
          <div className="flex gap-4 sm:justify-center md:justify-end my-6">
                <Typography as="a" href="#" className="transition-opacity hover:opacity-100">
                <svg className="h-5 w-5" fill={iconColor} viewBox="0 0 24 24" aria-hidden="true">
