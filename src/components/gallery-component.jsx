...
const Gallery = () => {
    return <div className="flex flex-col items-center mt-20 mx-2 md:ml-6 md:grid md:grid-cols-6 md:relative">
        ...
        <div className="w-[90%] my-3 md:col-start-4 md:col-end-7 md:w-[91%] md:ml-2 md:mr-12 md:order-4 md:place-self-start">
            <img src={image3} alt="exibition of abstract paintings"/>   
        </div>
        <div className="w-[90%] bg-black p-2 md:w-[91%] md:col-start-4 md:col-end-7 md:ml-2 md:order-4 md:absolute md:top-[67%] md:h-[32%]">
